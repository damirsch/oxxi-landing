...
const badgeVariants = cva(
	"flex justify-center items-center gap-1.5 bg-surface-background border border-primary-border w-fit font-heading text-secondary-text text-sm tracking-[-0.01em] transition-colors",
	{
		variants: {
			size: {
