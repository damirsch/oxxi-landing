			...
			<div className='py-5 lg:py-10'>
				<div className='relative py-px'>
					...
					<BgWrapper className='max-lg:bg-transparent max-lg:p-0 max-lg:rounded-none max-lg:outline-none'>
						<div className='relative flex flex-col gap-8 bg-[#191919] px-8 lg:px-[60px] xl:px-20 lg:py-24 xl:py-[120px] pt-10 rounded-none lg:rounded-[16px] w-full overflow-hidden'>
							<div className='flex flex-col gap-6 xl:gap-12 my-auto'>
								<p className='z-10 relative font-semibold text-[28px] text-white md:text-4xl xl:text-5xl leading-[1.1] tracking-[-0.01em]'>
							...
							<div className='lg:right-[5%] lg:-bottom-16 xl:bottom-2 lg:absolute relative mx-auto'>
