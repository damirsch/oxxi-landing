...
const HIRING_LOGOS: readonly PartnerLogo[] = [
...
const TECH_LOGOS: readonly PartnerLogo[] = [
...
export default async function Partners() {
	...
	const groups = [
		{ badge: t("hiringTeams"), borderBottom: true, logos: HIRING_LOGOS },
		{ badge: t("techPartners"), borderBottom: false, logos: TECH_LOGOS },
	]

	return (
		<SectionWrapper>
			<p className='text-tertiary-text text-sm text-center tracking-[-0.01em]'>
				{t("trustedBy")} <span className='font-semibold text-primary-text'>{t("highlight")}</span>
			</p>
