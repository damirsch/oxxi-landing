...
export function PricingEnterpriseBanner() {
	return (
		<div className='flex sm:flex-row flex-col sm:justify-between sm:items-center gap-4 bg-surface-background shadow-[0_2px_8px_0_rgba(0,0,0,0.04)] p-3 pr-4 border border-primary-border rounded-[16px] w-full'>
